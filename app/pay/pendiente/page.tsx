    ...
    <>
      ...
      <div className="ps-root">
        ...
        <main className="ps-main">
          ...
          <h1 className="ps-title">Pago en proceso</h1>
          <p className="ps-sub">Tu pago está siendo procesado. Esto puede tomar unos minutos. Te notificaremos cuando se confirme.</p>
...
export default function PayPendiente() {
  return (
    <Suspense>
      <PendienteContent />
    </Suspense>
...
const CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .ps-icon { font-size:72px; margin-bottom:20px; filter:drop-shadow(0 0 20px rgba(234,179,8,.4)); animation: pulse 2s ease-in-out infinite; }

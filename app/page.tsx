...
const FACEBOOK_URL = "https://www.facebook.com/fishflowmx";
const INSTAGRAM_URL = "https://www.instagram.com/fishflow.mx/";
              ...
              <ul className="space-y-2 text-sm text-white/70">
                ...
                <li className="flex items-center gap-3 pt-1">
                  <a
                    ...
                    aria-label="Facebook de FishFlow"
                    className="text-white/70 hover:text-white transition-colors"
                  >
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                      <path d="M22 12.06C22 6.5 17.52 2 12 2S2 6.5 2 12.06c0 5.02 3.66 9.18 8.44 9.94v-7.03H7.9v-2.91h2.54V9.85c0-2.52 1.49-3.91 3.77-3.91 1.09 0 2.23.2 2.23.2v2.47h-1.26c-1.24 0-1.62.77-1.62 1.56v1.88h2.76l-.44 2.91h-2.32V22c4.78-.76 8.44-4.92 8.44-9.94Z" />
                    </svg>
                  </a>
                  <a
                    href={INSTAGRAM_URL}
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Instagram de FishFlow"
                    className="text-white/70 hover:text-white transition-colors"
                  >
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
